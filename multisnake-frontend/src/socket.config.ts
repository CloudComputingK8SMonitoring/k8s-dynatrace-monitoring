...
export const SOCKET_SERVER = `ws://34.118.227.49:${SOCKET_PORT}`;
...
export const SOCKET_PLAYER_READY_PREFIX = 'ready';
export const SOCKET_PLAYER_DIED_PREFIX = 'died';
export const SOCKET_GAME_OVER_MSG = 'gameover';
